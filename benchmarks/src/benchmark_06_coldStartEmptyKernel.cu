...
void benchmarkColdStartEmptyKernel(vector<float> A, vector<float> B, vector<float> C, int m, int k, int n){
...
int main(int argc, char **argv){
    ...
    // Run the benchmark
    benchmarkColdStartEmptyKernel(A, B, C, MATRIX_SIZE, MATRIX_SIZE, MATRIX_SIZE);
